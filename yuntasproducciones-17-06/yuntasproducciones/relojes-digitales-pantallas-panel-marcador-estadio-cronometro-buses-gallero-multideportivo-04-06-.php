...
<head>
    ...
    <style>
        ...
        /* Remix Icons */
        :root{--swiper-theme-color:#007aff;--swiper-navigation-size:44px;}[class^="ri-"],[class*=" ri-"]{font-family:'remixicon' !important;font-style:normal;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}.ri-arrow-down-s-line:before,.ri-close-line:before,.ri-menu-line:before{content:'';display:inline-block;width:24px;height:24px;background-size:contain;background-repeat:no-repeat;vertical-align:middle;mix-blend-mode: difference;}.ri-message-2-line:before,.ri-whatsapp-line:before{content:'';display:inline-block;width:32px;height:37px;background-size:contain;background-repeat:no-repeat;vertical-align:middle}.ri-arrow-down-s-line:before{background-image:url('./assets/svg/arrow-down.svg')}.ri-close-line:before{background-image:url('./assets/svg/close-line.svg')}.ri-menu-line:before{background-image:url('./assets/svg/menu-line.svg')}.ri-message-2-line:before{background-image:url('./assets/svg/message-contactanos.svg')}.ri-whatsapp-line:before{background-image:url('./assets/svg/whatsapp-contactanos.svg')}
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide tranding-slide">
                            <div class="tranding-slide-img">
                                <img loading="lazy" src="./assets/productos-cards/IMAGE01_SLIDER-3D_PAGE05.webp" alt="tranding_image_slide" width="800" height="400">
                            </div>
                        </div>

                        <div class="swiper-slide tranding-slide">
                            <div class="tranding-slide-img">
                                <img loading="lazy" src="./assets/productos-cards/IMAGE02_SLIDER-3D_PAGE05.webp" alt="tranding_image_slide" width="640" height="320">
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide tranding-slide">
                            <div class="tranding-slide-img">
                                <img loading="lazy" src="./assets/productos-cards/IMAGE05_SLIDER-3D_PAGE05.webp" alt="tranding_image_slide" width="640" height="320">
                            </div>
                        </div>
