...
<body>
    ...
    <div id="main-portada">
        ...
        <div id="formulario-portada">
          ...
          <label class="titulo-form">¡APROVECHA ESTA <br> &nbsp;  &nbsp; OPORTUNIDAD!</label>
          <form id="formMain" method="post">
            ...
            <button type="submit" class="btn-formulario" name="submit" value="Enviar formulario">Obtener Asesoría</button>
