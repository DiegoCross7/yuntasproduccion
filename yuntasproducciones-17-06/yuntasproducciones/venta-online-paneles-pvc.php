...
<head>
    ...
    <title>Venta Online Paneles y PVC</title>
    <!-- ESTILOS GLOBALES -->
...
<body>
    ...
    <div class="carrusel carrusel2">
        <div class="imagen-slide activa" style="background-image: url('./assets/venta-online/slide-paneles-pvc-1.webp'); background-repeat: no-repeat; background-size: cover; ">
        </div>
        <div class="imagen-slide" style="background-image: url('./assets/venta-online/slide-paneles-pvc-2.webp'); background-repeat: no-repeat; background-size: cover; ">
        </div>
        <div class="imagen-slide" style="background-image: url('./assets/venta-online/slide-paneles-pvc-3.webp'); background-repeat: no-repeat; background-size: cover; ">
        </div>
    </div>
        ...
        <div class="products-container">
            <a class="product-card" href="./producto-detalle.php">
                <figure class="product-image">
                    <img src="./assets/venta-online/panel-pvc-product-1.webp" alt="Imagen 01">
                </figure>
            ...
            <a class="product-card" href="./producto-detalle.php">
                <figure class="product-image">
                    <img src="./assets/venta-online/panel-pvc-product-2.webp" alt="Imagen 02">
                </figure>
            ...
            <a class="product-card" href="./producto-detalle.php">
                <figure class="product-image">
                    <img src="./assets/venta-online/panel-pvc-product-3.webp" alt="Imagen 03">
                </figure>
            ...
            <a class="product-card" href="./producto-detalle.php">
                <figure class="product-image">
                    <img src="./assets/venta-online/panel-pvc-product-4.webp" alt="Imagen 04">
                </figure>
            ...
            <a class="product-card" href="./producto-detalle.php">
                <figure class="product-image">
                    <img src="./assets/venta-online/panel-pvc-product-5.webp" alt="Imagen 05">
                </figure>
            ...
            <a class="product-card" href="./producto-detalle.php">
                <figure class="product-image">
                    <img src="./assets/venta-online/panel-pvc-product-6.webp" alt="Imagen 06">
                </figure>
