...
<head>
    ...
    <link rel="preload" fetchpriority="high" as="image" href="./assets/proyectores-3d/PORTADA_PROYECTOR_3D01.webp" type="image/webp">
    <link rel="preload" fetchpriority="high" as="image" href="./assets/proyectores-3d/PORTADA_MOVIL01.webp" type="image/webp">
...
<body>
    ...
    <div id="main-portada">
        <!-- <img fetchpriority="high" src="./assets/productos-cards/PORTADA_PROYECTOR_3D.webp" alt="Imagen portada principal" class="principal-img"> -->
        ...
        <img src="./assets/productos-cards/IMAGE_SEMIAZUL.webp" id="semiazul" alt="Img-descuento"> -->
        <!-- <div class="slider">
            <div class="slider--inner">
                <img src="./assets/productos-cards/PORTADA_PROYECTOR_3D.webp" alt="Imagen" data-texto="Mejora visual, cuenta con una apariencia suave, difusa y colores de impacto." />
                <img src="./assets/productos-cards/PORTADA_PANTALLAS_LED.webp" alt="Imagen" data-texto="Caminando en Luz: Pisos LED, Donde Cada Paso Brilla" />
                <img src="./assets/productos-cards/PORTADA_PISO_LED.webp" alt="Imagen" data-texto="Caminando entre Luces: Pisos LED, Tu Suelo Iluminado" />
                <img src="./assets/productos-cards/PORTADA_PISO_LED.webp" alt="Imagen" data-texto="Caminando entre Luces: Pisos LED, Tu Suelo Iluminado" />
            </div>
        </div> -->
       ...
       <div class="swiper-containerp">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="titulo">
                        <h1>PROYECTOR 3D</h1>
                        <p class="slide-text-subtitle1">Mejora Visual, cuenta con una <br>apariencia suave, difusa y colores de impacto.</p>
                    </div>

                    <div class="descuento">
                        <label class="asesoria-gratis">ASESORIA GRATIS!!</label>
                        <img fetchpriority="low" loading="lazy" src="./assets/productos-cards/IMAGE_SEMIAZUL.webp" id="semiazul" alt="Img-descuento">
                    </div>
                    <img fetchpriority="low" loading="lazy" class="img-carp" src="./assets/proyectores-3d/PORTADA_PROYECTOR_3D01.webp" alt="Imagen 1" data-texto="Mejora visual, cuenta con una apariencia suave, difusa y colores de impacto.">
                    <img fetchpriority="high" class="img-movil" src="./assets/proyectores-3d/PORTADA_MOVIL01.webp" alt="Img-movil">
                    
                </div>
                <div class="swiper-slide">
                    <div class="titulo">
                        <h1>PROYECTOR 3D</h1>
                        <p class="slide-text-subtitle1">Sumérgete en la Magia del Cine en Casa</p>
                    </div>

                    <img loading="lazy" class="img-carp" src="./assets/proyectores-3d/PORTADA_PROYECTOR_3D02.webp" alt="Imagen 2" data-texto="Caminando en Luz: Pisos LED, Donde Cada Paso Brilla">
                    <img loading="lazy" class="img-movil" src="./assets/proyectores-3d/PORTADA_MOVIL02.webp" alt="Img-movil">

                </div>
                <div class="swiper-slide">
                    <div class="titulo">
                        <h1>TU PANTALLA GIGANTE EN 3D</h1>
                        <p class="slide-text-subtitle1">Imagina ver tus contenidos favoritos en una <br>pantalla inmersiva de hasta 300 pulgadas</p>
                    </div>


                    <img loading="lazy" class="img-carp" src="./assets/proyectores-3d/PORTADA_PROYECTOR_3D03.webp" alt="Imagen 3" data-texto="Caminando en Luz: Pisos LED, Donde Cada Paso Brilla" />
                    <img loading="lazy" class="img-movil" src="./assets/proyectores-3d/PORTADA_MOVIL03.webp" alt="Img-movil">
                </div>
                <div class="swiper-slide">
                    <div class="titulo">
                        <h1 class="title1">TRANSFORMA TU SALA EN UN CINE 3D PERSONAL</h1>
                        <p class="slide-text-subtitle1">Disfruta de efectos visuales asombrosos y <br>profundidad realista con nuestro proyector 3D</p>
                    </div>

                    <img loading="lazy" class="img-carp" src="./assets/proyectores-3d/PORTADA_PROYECTOR_3D04.webp" alt="Imagen 3" data-texto="Caminando en Luz: Pisos LED, Donde Cada Paso Brilla" />
                    <img loading="lazy" class="img-movil" src="./assets/proyectores-3d/PORTADA_MOVIL04.webp" alt="Img-movil">
                </div>
                <!-- Agrega más imágenes aquí según sea necesario -->
            </div>
        </div>

        <!-- <p class="subtitulo">Mejora visual, cuenta con una apariencia suave, difusa y colores de impacto.</p> -->
    ...
    <div class="section_01">
        ...
        <div class="content">
            <div class="content_p">
                <p class="paragraph">
                    - Experiencia visual impactante: Los hologramas 3D ofrecen una experiencia visual sorprendente que atrae y retiene
                    la atención de los espectadores de manera inmediata, gracias a sus imágenes realistas y en tres dimensiones.
                    <br><br>
                    - Diferenciación de marca: Utilizar tecnología holográfica permite a las marcas destacarse en un mercado competitivo,
                    creando una impresión memorable en los consumidores y estableciendo una asociación positiva con la innovación.
                </p>
            </div>

            <div class="content_img" style="background-image: url(assets/proyectores-3d/BACKGROUND_SECTION01_PAGE06.webp);">
            </div>
        </div>
    </div>
    ...
    <div class="section_02">
        ...
        <div class="content">
            <div class="content_img" style="background-image: url(assets/proyectores-3d/BACKGROUND_SECTION02_PAGE06.webp);"></div>
            <div class="content_p">
    ...
    <div class="section_03">
        ...
        <div class="content">
            ...
            <div class="content_img" style="background-image: url(assets/proyectores-3d/BACKGROUND_SECTION03_PAGE06.webp);"></div>
