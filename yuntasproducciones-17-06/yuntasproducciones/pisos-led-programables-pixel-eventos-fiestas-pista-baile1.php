...
<body>
    ...
    <div class="slider">
        <div class="slider--inner">
            <img src="./assets/productos-cards/PORTADA_PISO_LED01.webp" alt="Imagen" data-texto="Deslumbra tus Espacios: Pisos LED, Elegancia en Cada Paso"/>    
            <img src="./assets/productos-cards/PORTADA_PISO_LED02.webp" alt="Imagen" data-texto="Caminando en Luz: Pisos LED, Donde Cada Paso Brilla"/>      
            <img src="./assets/productos-cards/PORTADA_PISO_LED03.webp" alt="Imagen" data-texto="Caminando entre Luces: Pisos LED, Tu Suelo Iluminado" style="bottom:10px;"/>
        </div>
    </div>
        ...
        <div class="swiper-container carrusel">
            <div class="swiper-wrapper">
                <div class="swiper-slide item">
                    ...
                    <img src="./assets/productos-cards/CARRUSEL_PISO_EVENTOS.webp" class="img-piso" alt="carousel_image_01">
                </div>
                <div class="swiper-slide item">
                    <p class="text-carrusel">Pisos Led para fiestas</p>
                    <img src="./assets/productos-cards/CARRUSEL_PISO_FIESTAS.webp" class="img-piso" alt="carousel_image_02">
                </div>
                <div class="swiper-slide item">
                    <p class="text-carrusel">Pisos Led para bodas y mucho más</p>
                    <img src="./assets/productos-cards/CARRUSEL_MUCHO_MAS.webp" class="img-piso" alt="carousel_image_03">
                </div>
            </div>
    ...
    <div class="section_01">
        ...
        <div class="content">
            ...
            <div class="content_img" style="background-image: url(assets/productos-cards/BACKGROUND_SECTION01_PAGE04.jpg);"></div>
        </div>
    </div>
    ...
    <div class="section_02">
        ...
        <div class="content">
            <div class="content_img" style="background-image: url(assets/productos-cards/BACKGROUND_SECTION02_PAGE04.jpg);"></div>
            <div class="content_p">
    ...
    <div class="content">
            ...
            <div class="content_img" style="background-image: url(assets/productos-cards/BACKGROUND_SECTION03_PAGE04.jpg);"></div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide tranding-slide">
                            <div class="tranding-slide-img">
                                <img src="./assets/productos-cards/IMAGE01_SLIDER-3D_PAGE04.webp" alt="tranding_image_slide">
                            </div>
                        </div>

                        <div class="swiper-slide tranding-slide">
                            <div class="tranding-slide-img">
                                <img src="./assets/productos-cards/IMAGE02_SLIDER-3D_PAGE04.webp" alt="tranding_image_slide">
                            </div>
                        </div>

                        <div class="swiper-slide tranding-slide">
                            <div class="tranding-slide-img">
                                <img src="./assets/productos-cards/IMAGE03_SLIDER-3D_PAGE04.webp" alt="tranding_image_slide">
                            </div>
                        </div>

                        <div class="swiper-slide tranding-slide">
                            <div class="tranding-slide-img">
                                <img src="./assets/productos-cards/IMAGE04_SLIDER-3D_PAGE04.webp" alt="tranding_image_slide">
                            </div>
                        </div>

                        <div class="swiper-slide tranding-slide">
                            <div class="tranding-slide-img">
                                <img src="./assets/productos-cards/IMAGE05_SLIDER-3D_PAGE04.webp" alt="tranding_image_slide">
                            </div>
                        </div>
