...
<body>
    ...
    <div class="carrusel carrusel2">
        ...
        <div class="imagen-slide"
            style="background-image: url('./assets/venta-online/principal/venta-online-principal3.webp'); background-repeat: no-repeat; background-size: cover; width: 1100%; height: 100%;">
        </div>
        <div class="imagen-slide"
    ...
    <section class="descubre">
        <img src="./assets/venta-online/principal/descubre.webp" alt="Descubre" width="100%" height="auto">
    </section>
    ...
    <section class="explorar">
        ...
        <div class="explorar-images">
            <div class="explorar-images-presentacion">
                <img src="./assets/venta-online/principal/AnyConv2.webp" alt="explorar" width="100%" height="100%">
            </div>
            <div class="container-images">
                <a href="./venta-online-pisos-techos-led.php">
                    <div class="card-category">
                        <img src="./assets/venta-online/principal/category1.webp" alt="Imagen 1" width="100%" height="100%" loading="lazy">
                        <p>PISOS LED PARA FIESTAS, BODAS, ETC</p>
                    </div>
                </a>
                <a href="./venta-online-paneles-pvc.php">
                    <div class="card-category">
                        <img src="./assets/venta-online/principal/category2.webp" alt="Imagen 2" width="100%" height="100%" loading="lazy">
                        <p>PANEL ENMADERADO</p>
                    </div>
                </a>
                <a href="./venta-online-letreros-neon-led.php">
                    <div class="card-category">
                        <img src="./assets/venta-online/principal/category3.webp" alt="Imagen 3" width="100%" height="100%" loading="lazy">
                        <p>LETRERO NEÓN LED HAPPY BIRTHDAY</p>
                    </div>
                </a>
                <a href="./venta-online-pantallas-led.php">
                    <div class="card-category">
                        <img src="./assets/venta-online/principal/category4.webp" alt="Imagen 4" width="100%" height="100%" loading="lazy">
