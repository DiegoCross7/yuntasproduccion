...
<body>
    ...
    <div id="main-portada">
        ...
        <img 
          fetchpriority="high" 
          src="./assets/disenio-interiores/Disenio_Portada_01.webp" 
          srcset="
              ./assets/disenio-interiores/Disenio_Portada_01_small.webp 480w,
              ./assets/disenio-interiores/Disenio_Portada_01_medium.webp 800w,
              ./assets/disenio-interiores/Disenio_Portada_01_large.webp 1200w
          " 
    ...
    <section class="header_disenio">
        ...
        <div class="grid-container">
            <div class="grid-item">
                ...
                <img loading="lazy" src="./assets/disenio-interiores/Disenio_01.webp"
              srcset="./assets/disenio-interiores/Disenio_01-320w.webp 320w,
                      ./assets/disenio-interiores/Disenio_01-640w.webp 640w,
                      ./assets/disenio-interiores/Disenio_01-1280w.webp 1280w"
              sizes="(max-width: 320px) 280px,
                    (max-width: 640px) 600px,
                    1200px"
              alt="disenio-interiores01" width="100%" height="auto">
            </div>
            <div class="grid-item">
                <!-- <img loading="lazy" src="./assets/disenio-interiores/Disenio_02.webp" alt="disenio-interiores02" width="100%" height="100%"> -->
                  <img loading="lazy" src="./assets/disenio-interiores/Disenio_02.webp"
              srcset="./assets/disenio-interiores/Disenio_02-320w.webp 320w,
                      ./assets/disenio-interiores/Disenio_02-640w.webp 640w,
                      ./assets/disenio-interiores/Disenio_02-1280w.webp 1280w"
              sizes="(max-width: 320px) 280px,
                    (max-width: 640px) 600px,
                    1200px"
              alt="disenio-interiores02" width="100%" height="auto">
            </div>
            <div class="grid-item">
    ...
    <section class="header_disenio">
        ...
        <div class="contacto-container">
            ...
            <img 
        loading="lazy" 
        src="./assets/disenio-interiores/Disenio_3.webp" 
        alt="Contactanos"
        srcset="
            ./assets/disenio-interiores/Disenio_3-small.webp 480w,
            ./assets/disenio-interiores/Disenio_3-medium.webp 768w,
            ./assets/disenio-interiores/Disenio_3-large.webp 1024w,
            ./assets/disenio-interiores/Disenio_3-xlarge.webp 1200w
        "
...
@media (max-width: 500px) {
    ...
    <div class="footer_social_media">
      ...
      <a href="https://www.linkedin.com/company/yuntasproducciones/about/?viewAsMember=true" target="_blank">
        <img 
            srcset="./assets/redes_sociales/linkedin-200.webp 200w, 
                    ./assets/redes_sociales/linkedin-400.webp 400w, 
                    ./assets/redes_sociales/linkedin-800.webp 800w" 
            sizes="(max-width: 600px) 200px, (max-width: 1200px) 400px, 800px" 
            src="./assets/redes_sociales/linkedin-400.webp" 
            alt="social_icon" 
