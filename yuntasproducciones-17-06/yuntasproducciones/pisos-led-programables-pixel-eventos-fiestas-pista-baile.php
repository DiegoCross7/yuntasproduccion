...
<head>
    ...
    <title>Pisos-led-programables-pixel-eventos-fiestas-pista-baile</title>
    <!-- ESTILOS GLOBALES -->
...
<body>
    ...
    <div id="main-portada">
        ...
        <img src="./assets/productos-cards/IMAGE_SEMIAZUL.webp" loading="lazy"alt="semicirculo azul" id="semiazul">
        <div class="slider">
            <div class="slider--inner">
                <img src="./assets/productos-cards/PORTADA_PISO_LED01.webp" fetchpriority="low"  alt="Imagen" data-texto="Deslumbra tus Espacios: Pisos LED, Elegancia en Cada Paso"/>    
                <img 
                    src="./assets/productos-cards/PORTADA_PISO_LED02.webp" 
                    srcset="./assets/productos-cards/PORTADA_PISO_LED02-480w.webp 480w,
                            ./assets/productos-cards/PORTADA_PISO_LED02-800w.webp 800w,
                            ./assets/productos-cards/PORTADA_PISO_LED02-1200w.webp 1200w"
                    ...
                    loading="lazy" 
                    alt="Imagen" 
                    data-texto="Caminando en Luz: Pisos LED, Donde Cada Paso Brilla"/>      
                <img src="./assets/productos-cards/PORTADA_PISO_LED03.webp" loading="lazy" alt="Imagen" data-texto="Caminando entre Luces: Pisos LED, Tu Suelo Iluminado" style="bottom:10px;"/>
            </div>
        </div>
        ...
        <div class="swiper-container carrusel">
            <div class="swiper-wrapper">
                <div class="swiper-slide item">
                    <p class="text-carrusel">Pisos Led para eventos</p>
                    <img src="./assets/productos-cards/CARRUSEL_PISO_EVENTOS.webp" loading="lazy" class="img-piso" alt="carousel_image_01">
                </div>
                <div class="swiper-slide item">
                    <p class="text-carrusel">Pisos Led para fiestas</p>
                    <img src="./assets/productos-cards/CARRUSEL_PISO_FIESTAS.webp" loading="lazy" class="img-piso" alt="carousel_image_02">
                </div>
                <div class="swiper-slide item">
                    <p class="text-carrusel">Pisos Led para bodas y mucho más</p>
                    <img src="./assets/productos-cards/CARRUSEL_MUCHO_MAS.webp" loading="lazy" class="img-piso" alt="carousel_image_03">
                </div>
            </div>
    ...
    <div class="section_01">
        <div class="container_subtitles">
            <div class="subtitulos">
                <h2>DALE VIDA A TU PISTA DE BAILE</h2>
            </div>
        </div>
        <div class="content">
            <div class="content_p">
                <p class="paragraph">
                    Los pisos LED son superficies que pueden iluminarse en diferentes colores y patrones. Estos pisos
                    proporcionan una experiencia visual única al combinar la funcionalidad de una superficie transitable con
                    efectos de iluminación llamativos.
                </p>
            </div>

            <div class="content_img" style="background-image: url(assets/productos-cards/BACKGROUND_SECTION01_PAGE04.webp);"></div>
        </div>
    </div>
    ...
    <div class="section_02">
        ...
        <div class="content">
            <div class="content_img" style="background-image: url(assets/productos-cards/BACKGROUND_SECTION02_PAGE04.webp);"></div>
            <div class="content_p">
                <div class="content_info">
                    ...
                    <div class="sec_col">
                        <p>Permiten ajustar el color, la intensidad y los patrones de iluminación.</p>
                        <p>Se puede configurar diversos efectos visuales en movimiento.</p>
                        <p>Resistentes y duraderos, están diseñados para soportar la carga y el movimiento de personas.</p>
                        <p>Pueden mostrar logotipos, mensajes y gráficos relacionados con el evento.</p>
                        <p>Programación personalizada de secuencias de iluminación.</p>
                        <p>Instalación relativamente sencilla y rápida.</p>
                    </div>
                </div>
            </div>
    ...
    <div class="content">
            <div class="content_p">
                <div class="context-text">
                    <p><span>01</span> Pueden instalarse en una variedad de espacios, desde discotecas y escenarios hasta
                        centros comerciales y exhibiciones.</p>
                    <p><span>02</span> Se puede adaptar el diseño de los pisos a la temática específica de cualquier evento.</p>
                    <p><span>03</span> Experiencia visual inmersiva y única que puede elevar la calidad de tu evento.</p>
                </div>
            </div>
            <div class="content_img" style="background-image: url(assets/productos-cards/BACKGROUND_SECTION03_PAGE04.webp);"></div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide tranding-slide">
                            <div class="tranding-slide-img">
                                <img src="./assets/productos-cards/IMAGE01_SLIDER-3D_PAGE04.webp" loading="lazy" alt="tranding_image_slide">
                            </div>
                        </div>

                        <div class="swiper-slide tranding-slide">
                            <div class="tranding-slide-img">
                                <img src="./assets/productos-cards/IMAGE02_SLIDER-3D_PAGE04.webp" loading="lazy" alt="tranding_image_slide">
                            </div>
                        </div>

                        <div class="swiper-slide tranding-slide">
                            <div class="tranding-slide-img">
                                <img src="./assets/productos-cards/IMAGE03_SLIDER-3D_PAGE04.webp" loading="lazy" alt="tranding_image_slide">
                            </div>
                        </div>

                        <div class="swiper-slide tranding-slide">
                            <div class="tranding-slide-img">
                                <img src="./assets/productos-cards/IMAGE04_SLIDER-3D_PAGE04.webp" loading="lazy" alt="tranding_image_slide">
                            </div>
                        </div>

                        <div class="swiper-slide tranding-slide">
                            <div class="tranding-slide-img">
                                <img src="./assets/productos-cards/IMAGE05_SLIDER-3D_PAGE04.webp" loading="lazy" alt="tranding_image_slide">
                            </div>
                        </div>
