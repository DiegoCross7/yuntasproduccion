...
<head>
    <link rel="preload" as="image" href="./assets/Portada_Image.webp">
</head>
<style>
    .hero__container {
            background-image: linear-gradient(0deg, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7");
            background-image: linear-gradient(0deg, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("assets/Portada_Image.webp");
...
<section class="hero__container">
    <picture>
        <img src="./assets/Portada_Image.webp" class="hero__bg" alt="Image_Portada" />
    </picture>
