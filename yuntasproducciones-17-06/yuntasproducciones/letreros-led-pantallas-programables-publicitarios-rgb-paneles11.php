...
<head>
    ...
    <title>Letreros-led-pantallas-programables-publicitarios-rgb-paneles</title>
    <!-- ESTILOS GLOBALES -->
    ...
    <link rel="preload" im as="image" href="./assets/productos-cards/PORTADA_LETRERO_LED.webp" type="image/webp">
...
<body>
    ...
    <div id="main-portada">
        <img fetchpriority="high" src="./assets/productos-cards/PORTADA_LETRERO_LED.webp" alt="Imagen portada principal" class="principal-img">
        ...
        <div class="swiper-container carrusel">
            <div class="swiper-wrapper">
                <div class="swiper-slide item">
                    <p class="text-carrusel">Letrero Led programable</p>
                    <img loading="lazy" src="./assets/productos-cards/CARRUSEL_LETRERO_LED01.webp" class="img-piso" alt="carousel_image_01">
                </div>
                <div class="swiper-slide item">
                    <p class="text-carrusel">Letrero Led publicitario</p>
                    <img loading="lazy" src="./assets/productos-cards/CARRUSEL_LETRERO_LED02.webp" class="img-piso" alt="carousel_image_02">
                </div>
                <div class="swiper-slide item">
                    <p class="text-carrusel">Letrero Led RGB</p>
                    <img loading="lazy" src="./assets/productos-cards/CARRUSEL_LETRERO_LED03.webp" class="img-piso" alt="carousel_image_03">
                </div>
                <div class="swiper-slide item">
                    <p class="text-carrusel">Letrero Led personalizable</p>
                    <img loading="lazy" src="./assets/productos-cards/CARRUSEL_LETRERO_LED04.webp" class="img-piso" alt="carousel_image_04">
                </div>
                <div class="swiper-slide item">
                    <p class="text-carrusel">Letrero Led para negocio</p>
                    <img loading="lazy" src="./assets/productos-cards/CARRUSEL_LETRERO_LED05.webp" class="img-piso" alt="carousel_image_05">
                </div>
            </div>
    ...
    <div class="section_01">
        ...
        <div class="content">
            <div class="content_p">
                <p class="paragraph">
                    Los letretos led son de suma importancia, gracias a su ilumincación brillante y versátil, son altamente visibles
                    tanto de día como de noche, lo que aumenta la visibilidad de negocios y mensajes. Además, consumen menos
                    energía, lo que los convierte en una opción eficiente y atractiva para la señalización comercial y pública.
                </p>
            </div>
            <div class="content_img" style="background-image: url(assets/letreros-led/BACKGROUND_SECTION01_PAGE07.webp);"></div>
        </div>
    </div>
    ...
    <div class="section_02">
        ...
        <div class="content">
            <div class="content_img" style="background-image: url(assets/letreros-led/BACKGROUND_SECTION02_PAGE07.webp);"></div>
            <div class="content_p">
                <div class="content_info">
                    ...
                    <div class="sec_col">
                        <p>Flexbiles en términos de diseño y personalización.</p>
                        <p>Resistentes a condiciones adversas, como vibraciones, golpes y cambios climáticos.</p>
                        <p>Delgados y compactos, excelentes opción para espacios reducidos.</p>
                        <p>Legibilidad y comodidad visual.</p>
                        <p>Llamativos y dinámicos para atraer la atención de los clientes.</p>
                        <p>Excelentes para promocionar eventos especiales en tu negocio.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content">
            <div class="content_p">
                <div class="context-text">
                    <p><span>01</span> Energéticamente eficientes en comparación con otras opciones de iluminción. Disminuye la
                        necesidad de reemplazos frecuentes.</p>
                    <p><span>02</span> Ahorra tiempo y recursos en comparación con la creación y actualización manual de contenido
                        impreso.</p>
                    <p><span>03</span> Permiten mostrar contenido relevante y oportuno para tu negocio.</p>
                </div>
            </div>
            <div class="content_img" style="background-image: url(assets/letreros-led/BACKGROUND_SECTION03_PAGE07.webp);"></div>
        </div>
    </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide tranding-slide">
                            <div class="tranding-slide-img">
                                <img loading="lazy" src="./assets/productos-cards/IMAGE01_SLIDER-3D_PAGE07.webp" alt="tranding_image_slide">
                            </div>
                        </div>

                        <div class="swiper-slide tranding-slide">
                            <div class="tranding-slide-img">
                                <img loading="lazy" src="./assets/productos-cards/IMAGE02_SLIDER-3D_PAGE07.webp" alt="tranding_image_slide">
                            </div>
                        </div>

                        <div class="swiper-slide tranding-slide">
                            <div class="tranding-slide-img">
                                <img loading="lazy" src="./assets/productos-cards/IMAGE03_SLIDER-3D_PAGE07.webp" alt="tranding_image_slide">
                            </div>
                        </div>

                        <div class="swiper-slide tranding-slide">
                            <div class="tranding-slide-img">
                                <img loading="lazy" src="./assets/productos-cards/IMAGE04_SLIDER-3D_PAGE07.webp" alt="tranding_image_slide">
                            </div>
                        </div>

                        <div class="swiper-slide tranding-slide">
                            <div class="tranding-slide-img">
                                <img loading="lazy" src="./assets/productos-cards/IMAGE05_SLIDER-3D_PAGE07.webp" alt="tranding_image_slide">
                            </div>
                        </div>
