...
<head>
    ...
    <title>Venta Online Proyectores 3D</title>
    <!-- ESTILOS GLOBALES -->
...
<body>
    ...
    <div class="carrusel carrusel2">
        <div class="imagen-slide activa" cover style="background-image: url('./assets/venta-online/venta-online-slide-1.webp'); background-repeat: no-repeat; background-size: cover; ">
        </div>
        <div class="imagen-slide" style="background-image: url('./assets/venta-online/venta-online-slide-2.webp'); background-repeat: no-repeat; background-size: cover; ">
        </div>
        <div class="imagen-slide" style="background-image: url('./assets/venta-online/venta-online-slide-3.webp'); background-repeat: no-repeat; background-size: cover; ">
        </div>
    </div>
        ...
        <div class="products-container">
            ...
            <a class="product-card" href="./producto-detalle.php">
                <figure class="product-image">
                    <img src="./assets/venta-online/proyector-3d-wifi.webp" alt="Imagen 01">
                </figure>
            ...
            <a class="product-card" href="./producto-detalle.php">
                <figure class="product-image">
                    <img src="./assets/venta-online/proyector-3d-alta-resolucion.webp" alt="Imagen 02">
                </figure>
            ...
            <a class="product-card" href="./producto-detalle.php">
                <figure class="product-image">
                    <img src="./assets/venta-online/proyector-3d-hologramas-3d.webp" alt="Imagen 03">
                </figure>
            ...
            <a class="product-card" href="./producto-detalle.php">
                <figure class="product-image">
                    <img src="./assets/venta-online/proyector-3d-video-holografico.webp" alt="Imagen 04">
                </figure>
            ...
            <a class="product-card" href="./producto-detalle.php">
                <figure class="product-image">
                    <img src="./assets/venta-online/proyector-3d-hologramas-hd.webp" alt="Imagen 05">
                </figure>
            ...
            <a class="product-card" href="./producto-detalle.php">
                <figure class="product-image">
                    <img src="./assets/venta-online/proyector-3d-wifi.webp" alt="Imagen 06">
                </figure>
