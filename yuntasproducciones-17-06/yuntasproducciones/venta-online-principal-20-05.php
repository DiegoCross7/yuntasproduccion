            ...
            <div class="container-images">
                <a href="./venta-online-pisos-techos-led.php">
                    <div class="card-category">
                        <img loading="lazy" src="./assets/venta-online/principal/category1.webp" alt="category1" width="100%" height="100%">
                        <p>PISOS LED PARA FIESTAS, BODAS, ETC</p>
                    </div>
                </a>
                <a href="./venta-online-paneles-pvc.php">
                    <div class="card-category">
                        <img loading="lazy" src="./assets/venta-online/principal/category2.webp" alt="category2" width="100%" height="100%">
                        <p>PANEL ENMADERADO</p>
                    </div>
                </a>
                <a href="./venta-online-letreros-neon-led.php">
                    <div class="card-category">
                        <img loading="lazy" src="./assets/venta-online/principal/category3.webp" alt="category3" width="100%" height="100%">
                        <p>LETRERO NEÓN LED HAPPY BIRTHDAY</p>
                    </div>
                </a>
                <a href="./venta-online-pantallas-led.php">
                    <div class="card-category">
                        <img loading="lazy" src="./assets/venta-online/principal/category4.webp" alt="category4" width="100%" height="100%">
